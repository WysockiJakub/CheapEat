...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="/restaurateur/dashboard">Navbar</a>
...
<%--                    <a class="dropdown-item" href="#">Ulubione promocje</a>--%>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/restaurateur/promotion/list">Moje promocje</a>
                    <a class="dropdown-item" href="/restaurateur/promotion/add">Dodaj promocję</a>
<%--                    <div class="dropdown-divider"></div>--%>
