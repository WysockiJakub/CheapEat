...
<html>
<head>
    <title>Dodaj propozycję promocji</title>
...
<div>
    <form:form method="post" modelAttribute="promotion">
        ...
        <form:select path="restaurant" items="${restaurants}" itemLabel="name" itemValue="id" id="restaurantId"/>
        <form:errors path="restaurant" element="div"/>

        <br/><br/>

        <label for="restaurantId">Restauracja:</label>
        <form:select path="dayOfWeek" items="${restaurants}" itemLabel="name" itemValue="id" id="restaurantId"/>
        <form:errors path="restaurant" element="div"/>
