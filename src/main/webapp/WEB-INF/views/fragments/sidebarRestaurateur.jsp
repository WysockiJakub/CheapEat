...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/restaurateur/dashboard">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/restaurateur/dashboard">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/restaurateur/restaurant/profil">
            <i class="fas fa-concierge-bell"></i>
            <span>Restauracja</span></a>
    </li>
