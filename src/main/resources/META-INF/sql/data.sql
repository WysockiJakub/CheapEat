insert into restaurant (address, email, info, name, phoneNumber, website) VALUES ("Plac Konstytucji 1, 00-647 Warszawa", "restauracja@uszwejka.pl", "info1", "U Szwejka", "+48 22 339 17 10", "http://www.uszwejka.pl");
insert into restaurant (address, email, info, name, phoneNumber, website) VALUES ("ul. Marszalkowska 66, 00-545 Warszawa", "KONTAKT@SECADO.COM.PL", "info2", "Secado", "+48 608 707 799", "http://www.secado.com.pl");
insert into restaurant (address, email, info, name, phoneNumber, website) VALUES ("ul. Marszalkowska 115 , 00-545 Warszawa", "kontakt@restauracjasi.pl", "info3", "Si", "+48 507 099 190", "http://restauracjasi.pl");
insert into restaurant (address, email, info, name, phoneNumber, website) VALUES ("ul. Szkolna 2/4 , 00-006 Warszawa", "kontakt@banjaluka.pl", "info4", "Banjaluka", "+48 22 828 10 60", "http://www.banjaluka.pl");
insert into restaurant (address, email, info, name, phoneNumber, website) VALUES ("ul. Krolewska 1 , 00-065 Warszawa", "biuro@browarmia.pl", "info5", "Browarmia Krolewska", "+22 826 54 55", "http://browarmia.pl");
