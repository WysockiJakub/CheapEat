...
insert into restaurant (name, email, info, phoneNumber, website, city, street, houseNumber, zipCode, localizationUrl) VALUES ("Mniam", "example@mail.pl", "info4", "+48 123456789", "http://www.example.pl", "Warszawa", "Kokoszki", "4", "12-345", "asdasd");
...
insert into promotion (category, name, description, price, dayOfWeek, restaurant_id) values ("Obiady domowe", "Teriyaki Pork Steak", "stek z karkowki w marynacie teriyaki", 20.00, 1, 6);
